...
MainWindow::MainWindow() : QWidget()
{
    ...
    //
    const QPalette  homePalette(QColor(5,134,96));
    homeWidget->setPalette(homePalette);
    homeWidget->setAutoFillBackground(true);

    const QPalette  gameStartPalette(QColor(120,94,26));
    gameStartWidget->setPalette(gameStartPalette);
    gameStartWidget->setAutoFillBackground(true);
    //
